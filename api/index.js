...
// Removed 'vite' import as Vercel handles serving static files

dotenv.config();

const { Pool } = pg;
const app = express();
// Removed PORT constant and app.listen()
...
// Test DB connection (Optional logging for serverless)
// Note: In serverless, valid connections might not persist effectively between warm invocations in the same way,
// but pg pool handles this reasonably well.
(async () => {
    try {
